			...
			<div className="row main-body">
				...
				<div className="col-lg-6 questrial text-left home-margin">
					...
					<p className="main-page-p">
						...
						We do everything in house, from writing, recording, producing, mixing, mastering, designing artwork, planning promotion, distributing, and more. See <Link to="/artists">personas</Link> for detailed information on what a particular individual enjoys most.
					</p>
					<p className="main-page-p">
